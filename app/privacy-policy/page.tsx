...
export default function PrivacyPolicy() {
  return (
    <article className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      <p>Effective Date: Fri 1 Mar 2024</p>
      <p>
        At FlexiConvert, we are committed to safeguarding your privacy. This Privacy
      ...
      <section className="space-y-2">
        ...
        <p>
          ...
          <a href="mailto:pranshubasak@gmail.com"> pranshubasak@gmail.com</a>.
        </p>
      </section>

      <p>
        By using FlexiConvert, you agree to the practices outlined in this Privacy
